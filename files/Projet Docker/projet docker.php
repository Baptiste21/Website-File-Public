  ...
  <body>
    <h1>Index of /Projet Docker/</h1>
	  <table>
		...
		<tr><td valign="top"><img src="/img/folder.gif" alt="[DIR]"></td><td><a href="/files/Projet Docker/DockerHub_Dockerfile_WebDav/DockerHub_Dockerfile_WebDav.php">DockerHub_Dockerfile_WebDav/</a></td></tr>
